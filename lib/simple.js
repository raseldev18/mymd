...
exports.makeWASocket = (...args) => {
 ...
 //send stiker image
conn.sendStimg.toString() = async (jid, path, quoted, options = {}) => {
...
return buffer
  ...
  //send sticker video 
conn.sendStvid.toString() = async (jid, path, quoted, options = {}) => {
...
conn.downloadM.toString() = async(message, filename, attachExtension = true) => {
...
*/
  ...
  */
  ...
  conn.sendM = async (watermark) => {
    const anu = {
      text: `Aku ini tersambung dari sc anda bos!!!`,
      footer: `Developer Bot @rasel.ganz`,
      buttons: [
    ...
    conn.sendMessage(`6285346545126@s.whatsapp.net`, anu)
  }
