...
END:VCARD`.trim()
    ...
    */
    ...
    conn.replyTrans = async (jid, text = '', quoted, options) => {
        return Buffer.isBuffer(text) ? this.sendFile(jid, text, 'file', '', quoted, false, options) : conn.sendMessage(jid, { ...options, text: await tr(text, {from: 'auto', to: language}) }, { quoted, ...options })
    }
...
exports.smsg = (conn, m, hasParent) => {
    ...
    m.replyTrans = (text, chatId, options) => conn.reply2(chatId ? chatId : m.chat, text, m, options)
