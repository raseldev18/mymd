...
module.exports = {
    async handler(chatUpdate) {
	    ...
	    global.sock = conn    
                ...
                message: {
                    "productMessage": {
                        "product": {
                            "productImage":{
                                "mimetype": "image/jpeg",
                                "jpegThumbnail": buf //Gambarnye
                            },
                             title: a, //Kasih namalu 
                             description: "SELF BOT", 
                             currencyCode: "USD",
                             priceAmount1000: 100603,
                             retailerId: "Ghost",
                             productImageCount: 1
                        },
            ...
            global.ftroli = (a, buf) => ({
                ...
                message: {
                    orderMessage: {
                        ...
                        status: 1,
                        surface : 1,
                        message: a, //Kasih namalu
                        orderTitle: 'Bang',
                        thumbnail: buf, //Gambarnye
            ...
            let [_, code] = global.linkgc.match(linkRegex) || []
            global.fgclink = (o, buf) => ({
		    key: {
			    fromMe: false,
			    participant: "0@s.whatsapp.net",
		    ...
		    message: {
			    groupInviteMessage: {
				    groupJid: "6285346545126-1629709306@g.us",
				    inviteCode: code, 
				    groupName: "mengnama",
				    caption: o, 
				    jpegThumbnail: buf
